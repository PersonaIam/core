export const messages = {
    ...
    MORE_THAN_ONE_ATTRIBUTE_EXISTS:
        "More than one attribute exists for this owner and type. Please provide the attributeId instead of the type",
    ...
    REJECTED_ATTRIBUTE:
        "Attribute is rejected due to unsuccessful notarizations. Please update the attribute value and resume the notarization process",
    ...
    ATTRIBUTE_WITH_NO_ASSOCIATIONS_CANNOT_BE_VALIDATED:
        "Attribute has no associations and therefore cannot be validated",

    PENDING_APPROVAL_VALIDATION_REQUEST_ALREADY_EXISTS:
        "Validator already has a pending approval validation request for the given attribute",
    IN_PROGRESS_VALIDATION_REQUEST_ALREADY_EXISTS:
        "Validator already has an in progress validation request for the given attribute",
    COMPLETED_VALIDATION_REQUEST_ALREADY_EXISTS:
        "Validator already has a completed validation request for the given attribute",
    VALIDATION_REQUEST_MISSING_FOR_ACTION: "There is no validation request for this action",
    VALIDATION_REQUEST_MISSING_IN_STATUS_FOR_ACTION:
        "There is no validation request that is pending approval or in progress for this attribute",

    ATTRIBUTE_VALIDATION_REQUEST_NOT_IN_PROGRESS:
        "The specified attribute validation request must be in progress for the action to take place",
    ATTRIBUTE_VALIDATION_REQUEST_NOT_PENDING_APPROVAL:
        "The specified attribute validation request must be pending approval for the action to take place",

    ASSOCIATIONS_NOT_SUPPORTED_FOR_NON_FILE_TYPES: "Associations are not supported for non-file attribute types",
    ATTRIBUTE_ASSOCIATION_BASE_ATTRIBUTE_NOT_A_FILE:
        "Incorrect association provided : The base attribute must be of data type file",
    ATTRIBUTE_ASSOCIATION_DOES_NOT_EXIST_FOR_CURRENT_OWNER:
        "Incorrect association provided : one or more of the attributes to be associated does not exist or does not belong to the current owner",
    INCORRECT_VALIDATION_REQUEST_PARAMETERS:
        "Either the attribute id, the validation request validator or the attribute owner must be provided",
    ...
    VALIDATION_REQUEST_ANSWER_SENDER_IS_NOT_VALIDATOR_ERROR:
        "Only the validator is allowed to perform this action on a validation request",
    VALIDATION_REQUEST_ANSWER_SENDER_IS_NOT_OWNER_ERROR:
        "Only the owner is allowed to perform this action on a validation request",

    // TODO : add tests ( all 3 below )
    NO_CONSUMPTIONS_FOR_REWARD_ROUND:
        "The reward was round not generated because there were no attribute consumptions since the last completed reward round",
    ...
    MISSING_NUMBER_OF_VALIDATIONS_REQUIRED:
        "Service attribute validations required number is not provided. Nothing to create",
    ...
    IDENTITY_USE_REQUEST_MISSING_IN_STATUS_FOR_ACTION:
        "There is no identity use request that is pending approval or active for this attribute",
    ...
    IDENTITY_USE_REQUEST_NOT_PENDING_APPROVAL:
        "The specified identity use request must be in pending approval status for the action to take place",
    IDENTITY_USE_REQUEST_ALREADY_EXISTS:
        "The given attribute already has an identity use request for the given service",
    IDENTITY_USE_REQUEST_ANSWER_SENDER_IS_NOT_PROVIDER_ERROR:
        "Only the service provider is allowed to perform this action on an identity use request",
    IDENTITY_USE_REQUEST_ANSWER_SENDER_IS_NOT_OWNER_ERROR:
        "Only the owner is allowed to perform this action on an identity use request",
    ...
    IDENTITY_USE_REQUEST_ACTION_FOR_INACTIVE_SERVICE:
        "No action can be performed on an identity use request which belongs to an inactive service",
    ...
    REQUIRED_SERVICE_ATTRIBUTES_ARE_MISSING_EXPIRED_OR_INACTIVE:
        "Cannot create identity use request : some attributes are expired or are missing required validations",
