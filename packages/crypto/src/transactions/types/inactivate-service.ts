...
export class InactivateServiceTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.InactivateService;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.inactivateService;
    }
