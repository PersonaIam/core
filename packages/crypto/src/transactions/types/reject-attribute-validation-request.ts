...
export class RejectAttributeValidationRequestTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.RejectAttributeValidationRequest;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.rejectAttributeValidationRequest;
    }
