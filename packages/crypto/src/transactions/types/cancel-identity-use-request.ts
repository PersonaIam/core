...
export class CancelIdentityUseRequestTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.CancelIdentityUseRequest;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.cancelIdentityUseRequest;
    }
