...
export class EndIdentityUseRequestTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.EndIdentityUseRequest;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.endIdentityUseRequest;
    }
