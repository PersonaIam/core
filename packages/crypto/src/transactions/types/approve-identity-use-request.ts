...
export class ApproveIdentityUseRequestTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.ApproveIdentityUseRequest;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.approveIdentityUseRequest;
    }
