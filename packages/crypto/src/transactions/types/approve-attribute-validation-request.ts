...
export class ApproveAttributeValidationRequestTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.ApproveAttributeValidationRequest;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.approveAttributeValidationRequest;
    }
