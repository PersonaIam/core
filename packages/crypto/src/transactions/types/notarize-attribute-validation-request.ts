...
export class NotarizeAttributeValidationRequestTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.NotarizeAttributeValidationRequest;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.notarizeAttributeValidationRequest;
    }
