...
export class RequestAttributeValidationTransaction extends Transaction {
    public static type: TransactionTypes = TransactionTypes.RequestAttributeValidation;

    public static getSchema(): schemas.TransactionSchema {
        return schemas.requestAttributeValidation;
    }
